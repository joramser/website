    ...
    <main className="lg:mt-8">
      <section className="flex flex-col lg:flex-row md:text-md animate-slow-fade-in">
        ...
        <div className="mt-8 md:mt-12 md:pl-16 lg:mt-0">
          <h1 className="pt-4 text-center text-3xl md:text-4xl font-bold text-white sm:pt-0 md:text-left">
            About
          </h1>
          <div className="mt-4 text-lg tracking-wide">
            <p className="">
              ...
              <span className="text-sm">[ˈxoɾxe]</span>. I&apos;m a Software
              Engineer with 10 years of experience working on the field.
            </p>
            <p className="mt-4">
              This is my little{" "}
              <BasicLink
              ...
              . I am still working on it but I wanted to put something out there
              already even if it&apos;s not &quot;perfect&quot; 🚧.
            </p>
            <p className="mt-4">
              My goal is to share my musings about my work and experiences as a
              developer, but also about any other topics might be interesting.
            </p>
            ...
            <ul className="mt-4 ml-8 list-disc">
              <li className="mt-2">
                ...
                <EmphasisText color="yellow">
                  Cartagena de Indias, Colombia
                </EmphasisText>
                . But decided one can just get enough of the sun and decided to
                move to <EmphasisText color="cyan">Estonia</EmphasisText>{" "}
                (kidding, I love it here).
              </li>
              <li className="mt-2">
                I got into <EmphasisText color="sky">programming</EmphasisText>{" "}
                thanks to my dad. He had QBASIC and Visual Basic books laying
                around in the house that I randomly picked and got hooked since
                then.
              </li>
              <li className="mt-2">
                My main hobby is the{" "}
                <EmphasisText color="rose">guitar</EmphasisText>. I am a lefty
                and my main thing is playing heavy metal (I even was in a metal
                band in my uni years).
              </li>
              <li className="mt-2">
                I love <EmphasisText color="amber">cooking</EmphasisText>. From
                simple home-cooking, to food science, to baking, to making more
                elaborate dishes. You name it!
              </li>
            </ul>
          </div>
        </div>
